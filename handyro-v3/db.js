...
async function seedIfEmpty() {
  ...
  await db.workers.insert([
    { _id: w1Id, user_id: ionutId, specialization: 'Toate categoriile', price_per_hour: 100, rating: 5.0, reviews_count: 214, city: 'București', available: true },
    { _id: w2Id, user_id: mihaiId, specialization: 'Instalații electrice', price_per_hour: 120, rating: 5.0, reviews_count: 0, city: 'București', available: true },
  ]);

  const job1Id = 'job_1';
  const job2Id = 'job_2';
  await db.jobs.insert([
    { _id: job1Id, client_id: mariaId, worker_id: w1Id, category: 'Instalații sanitare', description: 'Robinet defect în bucătărie', urgency: 'urgent', time_slot: 'După-amiaza', photos: [], status: 'accepted', city: 'București', created_at: now },
    { _id: job2Id, client_id: danId,   worker_id: w1Id, category: 'Renovări & zugrăveală', description: 'Cameră 18mp', urgency: 'normal', time_slot: 'Dimineața', photos: [], status: 'pending', city: 'București', created_at: now },
  ]);
